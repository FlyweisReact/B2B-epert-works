...
import Training from "./component/Live Traning/Training";
import Summary from "./component/Summary/Summary";
import Trial from "./component/Trial/Trial";
import Subscription from "./component/Subscription/Subscription";
import Billing from "./component/Subscription/Billing";
import Thankyou from "./component/Subscription/Thankyou";
  ...
  const getMenuItems = async () => {
    ...
    if (authState) {
      ...
      localStorage.setItem(
        "menuItems",
        JSON.stringify(response?.result?.pages || [])
      );
    }
  };
  useEffect(() => {
  ...
  return (
    <div className="App">
      <Switch>
        ...
        <RouteWithErrorBoundary path="/Home" component={LandingPage} exact />




        <RouteWithErrorBoundary path="/old" component={ErrorScreen} exact />
        <RouteWithErrorBoundary path="/" component={LandingPageHomePage} exact />
        <RouteWithErrorBoundary path="/addCourse" component={AddCourse} exact />
        <RouteWithErrorBoundary path="/train" component={Training} exact />
        <RouteWithErrorBoundary path="/enrollment" component={Summary} exact />

        <RouteWithErrorBoundary path="/courses" component={LMSMain} exact />
        <RouteWithErrorBoundary
          path="/course/:name/:level"
          render={() => <LMSVideos />}
          exact
        />
        ...
        <RouteWithErrorBoundary path="/trial" component={Trial} exact />
        <RouteWithErrorBoundary
          path="/subscription"
        ...
        <RouteWithErrorBoundary
          path="/super-admin/add-partner"
          component={SuperAdmin}
          exact
        />
        <RouteWithErrorBoundary
          path="/super-admin/add-group"
          component={Group}
          exact
        />
        <RouteWithErrorBoundary
          path="/super-admin/add-team"
          component={Team}
          exact
        />
        <RouteWithErrorBoundary
        ...
        />
        <RouteWithErrorBoundary
          path="/expert-business"
          component={ExpertBusiness}
          exact
        />
