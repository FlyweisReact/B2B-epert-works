            ...
            <div className="container">
              <div className="row">
                <div className="col-lg-12">
                  <h2 className="pageTitle">Courses
                  {/* <span className="beta-syle">Beta Version</span> */}
                  </h2>
                </div>
              </div>
            </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <CustomPopover course={course}>
                          <p onClick={() => clickHandler(course)}  className="add-mar">
                            <img
                              src={course.img}
                              alt="#"
                            ...
                            <div className="courses-down-content">
                              ...
                              {/* <div className="rating-left">
                                ...
                                { userRole === "ROLE_ADMIN" || "ROLE_USER" ? " " : <h4> {Math.floor(course.price) === 0 ? 'free' :<>
