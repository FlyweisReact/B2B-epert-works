...
import img from "../../../img/Event/WhatsApp Image 2022-11-08 at 9.34.54 PM.jpeg";
    ...
    <div>
      <div className="home-image-space">
        <div className="section-heading">
          <h2>
            Learning at <em>Expert Works</em>
          </h2>
          <span>
            The training is provided by the best industry experts, who are
            always available to clarify your doubts.
          </span>
        </div>
        <div className="home-images">
          <div>
            ...
            <div className="down-content">
              ...
              <p>
                Self-paced and Flexible learning that fits your needs. Subscribe
                and learn at your own terms{" "}
              </p>
            </div>
          </div>
          <div>
            ...
            <div className="down-content">
              {" "}
              <h4>Hassle free training </h4>
              <p>
                Forget the hassles of getting your consultants trained
                individually and worry less about paying more!{" "}
              </p>
            </div>
          </div>
          <div>
            ...
            <div className="down-content">
              ...
              <h4>Get certified</h4>
              <p>
                Showcase your skills on your resume and LinkedIn profile. Get a
                verified certificate on complete of the course.{" "}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="GalleryImages">
        <h4>
          We take great pride in our partnership with IT Serve Synergy 2022. Our
          tech expo experience was more encouraging than ever.
        </h4>
        <section
          className="main-card--container"
          style={{ color: "black", marginBottom: "10%"  , margin}}
        >
          {Images.map((i) => {
            return (
              <>
      ...
      <div className="fun-facts">
        <div className="home-container2">
          <div className="left-content">
            ...
            <h2 className="home-justify">
              Increase your chances of getting hired by{" "}
              <em>Fortune 500 companies</em>
            </h2>
            <p className="home-justify">
              Expert Works is the ideal platform to learn any on-demand
              technology without worrying about time and money.
              <br />
              <br />
              With self-paced learning, you can learn things on your terms. Try
              Expert-works today and experience the difference yourself!
            </p>
      ...
      <div className="home-container3">
        ...
        <div className="right-content">
          ...
          <h2>
            Get to know about <em className="our-company">our company</em>
          </h2>
          <p>
            Expert-Works draws a global network of consultants with the large
            panel of experts having deep industry experience and nurture the
            best talent to help your organization grow. <br />
            <br />
            We provide assistance in finding new and experienced talents in
            various technologies. Subscribe to any of our subscription models to
            get access to our portal and achieve the flexibility of training as
            many consultants as you want.{" "}
          </p>
      ...
      <div className="home-container4">
        <div className="left-content">
          ...
          <h2>
            Upskill your data skill for
            <em className="career-growth"> career growth</em>
          </h2>
          <p>
            Expert Works is a leading cloud based, e-learning platform! We
            provide in-demand, self paced tech courses with real time content.
            Now, it&rsquo;s easy to get trained and learn everything by
            yourself, at your own pace!
            <br />
            <br />
            Subscribe to any of our subscription models to get access to our
            portal and achieve the flexibility of training.
          </p>
          <Link to="/about-us" className="button2">
            Read More
          </Link>
        </div>
        <div>
      ...
      <div className="home-container5">
        <div>
          <h2>
            What they say <em className="home-about-us">about us</em>
          </h2>
        ...
        <div className="inner-container">
          <div>
            <div className="cont5-box">
              ...
              <p>
                ...
                their Salesforce admin course and completed the entire course in
                a couple of months. The video quality is good and they respond
                quickly to emails, so I found it very helpful and convenient."
              </p>
            </div>
          ...
          <div>
            <div className="cont5-box">
              ...
              <span></span>
              <p>
                "I purchased the Machine Learning course and enjoyed doing the
                mini-projects assigned. Other platforms were charging extra for
                the mini-projects but with Expert-Works, I received a lot of
                bonuses and a course completion certificate as well."
              </p>
            </div>
            <div className="smallimage">
