        ...
        videoData.result.sections.forEach((section: any, index: number) => {
          ...
          if (section.videoLinks) {
            ...
            subSections
              ...
              //   <AccordionDetails>
              //     <Typography>
              //       <div className="courseSection">{courseSection} {console.log('courseSection' , courseSection) }  </div>
              //     </Typography>
              //   </AccordionDetails>
              // </Accordion>
              ();
    ...
    <div className="mainDivVideos no-scroll">
      ...
      <div className="flex-container">
        ...
        <div className="sidebar">
          ...
          <div className="content_description" aria-label="Related Clips">
          {console.log(videoData?.result?.sections?.map((i , index) => (
            ...
            <Accordion>
              ...
              <AccordionDetails>
                <Typography>
                  ...
                  <div className="courseSection">fdsfsd </div>
                </Typography>
              </AccordionDetails>
            </Accordion>
          </div>
