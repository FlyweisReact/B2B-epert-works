...
function PersistentDrawerLeft(props: any) {
  ...
  const unFold = Boolean(anchorEl)
  
  const handleClick = (event: any) => {
    setAnchorEl(event.currentTarget);
  };
  const handleCL = (event: any) => {
    setAnchorEl(event.currentTarget);
  };
  const handleClose = () => {
    setAnchorEl(null);
  ...
  return (
    <Box>
      ...
      >
        <MenuItem onClick={closeHandel}>Profile</MenuItem>
        <MenuItem onClick={closeHandel}>My account</MenuItem>
        <MenuItem onClick={closeHandel}>Logout</MenuItem>
      </Menu>
              </div>
            </li>
