          ...
          <ul className="nav-menu desktopOnly">
            ...
            <li>
              <div className="nav-links-main">
                ...
                >
                  <MenuItem onClick={closeHandel}    className='menu_I'>Blogs</MenuItem>
                  <MenuItem onClick={closeHandel}    className='menu_I'>Guides</MenuItem>
                  <MenuItem onClick={closeHandel}    className='menu_I'>Webniar</MenuItem>
                  <MenuItem onClick={() =>  navigationHandler("/logout")}    className='menu_I'>Events</MenuItem>
                </Menu>
              </div>
            </li>
