...
function PersistentDrawerLeft(props: any) {
  ...
  const unlock = Boolean(anchorEl);
  const handleCK = (event: React.MouseEvent<HTMLButtonElement>) => {
          ...
          <ul className="nav-menu desktopOnly">
            ...
            <li>
              <div className="nav-links-main">
                <select className="nav-links" id='dropDN' style={{border : 'none'}}> 
                <option style={{ color: "black" }}>Resources</option>
                <option style={{ color: "black" }}>Resources</option>
                <option style={{ color: "black" }}>Resources</option>
                <option style={{ color: "black" }}>Resources</option>
                </select>
