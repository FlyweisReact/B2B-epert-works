          ...
          <ul className="nav-menu desktopOnly">
            ...
            <li>
              <div className="nav-links-main">
                ...
                >
                  <MenuItem onClick={closeHandel}    className='menu_I'><Blogs></Blogs></MenuItem>
                  <MenuItem onClick={closeHandel}    className='menu_I'>My account</MenuItem>
                  <MenuItem onClick={closeHandel}    className='menu_I'>Logout</MenuItem>
                </Menu>
              </div>
            </li>
