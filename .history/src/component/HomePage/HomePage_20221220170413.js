  ...
  return (
    <>
      ...
      <div className="HomeBIg">
        ...
        <div className="left">
          <p>
            I had an amazing experience with Expert-Works. I Purchased their Salesforce admin course and complete the entire course in a couple of months. The video quality is good and they respond quickly
          </p>
        </div>
