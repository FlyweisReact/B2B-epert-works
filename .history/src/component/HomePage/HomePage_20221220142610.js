      ...
      <div className="HomeNewTwoSec">
        <div className="left">
          ...
          <ul style={{ listStyleType: "disc" }}>
            <li>
              {" "}
              <div className="ListHome"></div> Hybrid Learning
            </li>
            <li>
              {" "}
              <div className="ListHome"></div> Up-to Date Course Content
            </li>
            <li>
              {" "}
              <div className="ListHome"></div> Real-Time Assignments & Projects
            </li>
            <li>
              {" "}
              <div className="ListHome"></div> Get Certifications
            </li>
            <li>
              {" "}
              <div className="ListHome"></div> Dedicated Team for Support
            </li>
          </ul>
        </div>
        <div className="right">
