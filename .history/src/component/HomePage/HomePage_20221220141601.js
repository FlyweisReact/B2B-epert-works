  ...
  return (
    <>
      ...
      <div className="HomeNewTwoSec">
        <div className="left">
          <p>Why</p>
          <p style={{ fontWeight: "bold" }}>EXPERT-WORKS?</p>
          <ul style={{ listStyleType: "disc" }}>
            ...
            <li>  <div
              ...
              ></div>{" "} Up-to Date Course Content</li>
            <li>  <div
                style={{
                  backgroundColor: "black",
                  width: "10px",
              ...
              ></div>{" "} Real-Time Assingments & Projects</li>
            <li>  <div
                style={{
                  backgroundColor: "black",
                  width: "10px",
            ...
            <li>  <div
              ...
              ></div>{" "}Dedicated Team for Support</li>
          </ul>
        </div>
        <div className="right">
          <img src={img} alt="" />
